  ...
  return (
    <div className="min-h-screen bg-[#eef0fb] flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        {/* ── LEFT PANEL ── */}
        <div className="w-[520px] flex-shrink-0 flex flex-col justify-center px-14 py-12 relative overflow-hidden">

          {/* Badge */}
          <span className="inline-flex items-center gap-1.5 bg-white text-blue-700 text-xs font-medium px-3 py-1.5 rounded-full border border-blue-100 shadow-sm mb-8 self-start">
          ...
          <div className="relative">
            {/* Dashed swirl arrow */}
            <svg className="absolute right-[60px] top-[-50px] w-32 h-20 pointer-events-none" viewBox="0 0 128 80" fill="none">
              <path d="M 10 70 Q 40 20 80 40 Q 100 50 108 30" stroke="#3b82f6" strokeWidth="1.5" strokeDasharray="5 4" fill="none" opacity="0.6"/>
              {/* Arrow head */}
              <path d="M 102 22 L 110 28 L 116 18" stroke="#3b82f6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.6"/>
            </svg>
            ...
            <div className="flex flex-col gap-3 max-w-[300px]">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="bg-blue-500 text-white text-sm px-4 py-2.5 rounded-2xl rounded-tl-sm shadow-sm max-w-[200px]">
              ...
              <div className="flex items-center gap-3 ml-2">
                <div className="w-9 h-9 rounded-full bg-purple-200 flex items-center justify-center text-xs font-bold text-purple-700 flex-shrink-0">B</div>
                <div className="bg-white text-gray-800 text-sm px-4 py-2.5 rounded-2xl shadow-sm border border-gray-100">
                  How about sushi? 🍣
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 ml-4">
                <div className="w-9 h-9 rounded-full bg-pink-200 flex items-center justify-center text-xs font-bold text-pink-700 flex-shrink-0">C</div>
                <div className="bg-purple-500 text-white text-sm px-4 py-2.5 rounded-2xl rounded-tl-sm shadow-sm">
                  Works for me! 🎉
                </div>
              </div>
            </div>

            {/* People circle icon with sparks */}
            <div className="absolute right-[20px] bottom-[-10px]">
              <div className="relative">
                <svg className="absolute -inset-4 w-24 h-24 pointer-events-none" viewBox="0 0 96 96">
                  <line x1="48" y1="6" x2="48" y2="14" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round"/>
                  <line x1="76" y1="20" x2="82" y2="14" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round"/>
                  <line x1="20" y1="20" x2="14" y2="14" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round"/>
                  <line x1="84" y1="48" x2="92" y2="48" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round"/>
                </svg>
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-md border border-gray-100 relative z-10">
                  <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
                  </svg>
                </div>
                {/* Gold star */}
                <div className="absolute -top-1 -right-3 text-yellow-400 text-lg leading-none">✦</div>
                {/* Blue diamond */}
                <div className="absolute -bottom-4 right-[-20px] text-blue-400 text-lg leading-none">✦</div>
              </div>
            </div>
          </div>
