  ...
  return (
    <div className="min-h-screen" style={{ background: "#f0ece3" }}>
      ...
      <div className="relative overflow-hidden" style={{ background: "#f0ece3" }}>
        ...
        <div className="absolute top-3 right-3 pointer-events-none opacity-50" style={{ zIndex: 0 }}>
        ...
        {/*
          Layout: 3 columns
          Col 1: text (z-index 10, in front)
          Col 2: food bowl (z-index 5, BEHIND chat card)
          Col 3: chat card (z-index 20, fully on top)
        */}
        <div className="flex items-center px-12 py-10 gap-0" style={{ minHeight: "520px" }}>

          {/* ── COL 1: Text ── */}
          <div style={{ width: "320px", flexShrink: 0, zIndex: 10, position: "relative" }}>
          ...
          {/* ── COL 2: Food bowl — BEHIND chat card ── */}
          <div
            className="relative flex items-center justify-center"
            style={{ width: "480px", flexShrink: 0, zIndex: 5, marginRight: "-140px", position: "relative" }}
          >
            {/* Peach glow circle */}
            <div
              className="absolute rounded-full"
              style={{ width: "480px", height: "480px", background: "#e8c4a8", opacity: 0.5, zIndex: 0 }}
            />
            {/* Spark */}
            <svg
              className="absolute pointer-events-none"
              style={{ top: "20px", left: "30px", zIndex: 1 }}
            ...
            <img
              ...
              style={{ width: "460px", height: "460px", zIndex: 2 }}
            />
          </div>

          {/* ── COL 3: Chat card — ON TOP of bowl ── */}
          <div
            className="relative bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden"
            style={{ width: "340px", flexShrink: 0, zIndex: 20 }}
          >
            {/* Header */}
                ...
                <div className="flex -space-x-1.5">
                  {(["A", "B", "C", "D"] as const).map((l, i) => {
                    ...
                    return (
                      <div
                        key={l}
                        className={`w-7 h-7 rounded-full border-2 border-white flex items-center justify-center text-[10px] font-bold ${colors[i]}`}
                      >
                        {l}
                      </div>
                    );
            ...
            <div className="px-4 py-3 space-y-2">
              ...
              {[
                ...
                <div key={m.time} className="flex items-end gap-2">
                  <div className={`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-[10px] font-bold ${m.color}`}>
                    {m.user}
                  </div>
                  <div>
      ...
      <div id="features" className="max-w-5xl mx-auto px-8 pt-10 pb-8">
        <h2
          className="text-center font-black uppercase mb-8 tracking-wide"
          style={{ fontSize: "1.15rem", color: "#1a1a0e", letterSpacing: "0.04em" }}
        >
            ...
            <div key={card.title} className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <div className="flex items-start gap-3 mb-3">
                <div
                  ...
                  style={{ background: card.bgIcon, color: card.iconColor }}
                >
                  {card.icon}
                </div>
                <h3
                  className="text-sm font-black uppercase tracking-wide leading-tight pt-0.5"
                  style={{ color: "#1a1a0e", whiteSpace: "pre-line" }}
                >
                  {card.title}
                </h3>
              </div>
      ...
      <div id="how-it-works" className="max-w-5xl mx-auto px-8 pt-8 pb-8">
        <h2
          className="text-center font-black uppercase mb-6 tracking-wide"
          style={{ fontSize: "1.15rem", color: "#1a1a0e", letterSpacing: "0.04em" }}
        >
          HOW IT WORKS
        </h2>
            ...
            <div key={step.num} className="flex items-center">
              <div className="flex items-center gap-3">
                <div className="relative flex-shrink-0">
                  ...
                  <div
                    className="absolute -top-1 -left-1 w-5 h-5 rounded-full text-white text-[10px] font-black flex items-center justify-center"
      ...
      {/* ── CTA ── */}
      <div
        className="relative overflow-hidden border-t py-14 px-8"
        style={{ background: "#e8eedd", borderColor: "#d4e4b0" }}
      >
        ...
        <div className="relative text-center" style={{ zIndex: 10 }}>
          ...
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 px-8 py-3 text-white rounded-xl font-bold text-sm hover:opacity-90 shadow-md"
            style={{ background: "#5a7a2e" }}
          >
            Create your account
