...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ background: "#f0ece3" }}>
      ...
      {/* ── HERO ── */}
      <div className="relative overflow-hidden" style={{ background: "#f0ece3" }}>
          ...
          {Array.from({ length: 7 }).map((_, row) => (
            <div key={row} className="flex gap-2.5 mb-2.5">
              {Array.from({ length: 8 }).map((_, col) => (
                <div key={col} className="w-1.5 h-1.5 rounded-full" style={{ background: "#d4a0a0" }} />
              ))}
            </div>
          ))}
        </div>

        {/* Full-width hero, no max-w constraint so food+chat fill the right side */}
        <div className="flex items-center pl-16 pr-0 py-10" style={{ minHeight: "520px" }}>
          ...
          <div style={{ width: "320px", flexShrink: 0 }}>
            ...
            <h1 className="font-black leading-none uppercase mb-4" style={{ fontSize: "3.4rem", color: "#1a1a0e", lineHeight: 1.0 }}>
              ORDER FOOD TOGETHER,{" "}
              <span style={{ color: "#6b8f3e" }}>WITHOUT THE CHAOS</span>
            </h1>

            <p className="text-sm leading-relaxed mb-6" style={{ color: "#666", maxWidth: "280px" }}>
            ...
            <div className="flex flex-col gap-3" style={{ maxWidth: "280px" }}>
              <Link href="/signup" className="inline-flex items-center justify-center gap-2 px-6 py-3 text-white rounded-xl font-bold text-sm hover:opacity-90 transition-colors shadow-md" style={{ background: "#5a7a2e" }}>
                Get started free
            ...
            <div className="flex items-center gap-1.5 mt-3">
              <svg className="w-3.5 h-3.5" style={{ color: "#e88080" }} fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
              </svg>
          ...
          {/* CENTER+RIGHT — food bowl overlapping chat card */}
          <div className="relative flex-1 flex items-center justify-end" style={{ height: "520px" }}>

            {/* Soft circle behind bowl */}
            <div className="absolute rounded-full pointer-events-none" style={{ width: "420px", height: "420px", background: "#e8c4a8", opacity: 0.55, left: "60px", top: "50%", transform: "translateY(-50%)" }} />

            {/* Spark accent */}
            <svg className="absolute pointer-events-none" style={{ left: "110px", top: "60px" }} width="36" height="36" viewBox="0 0 36 36" fill="none">
              <line x1="18" y1="3" x2="18" y2="13" stroke="#f472b6" strokeWidth="2.5" strokeLinecap="round"/>
              <line x1="27" y1="10" x2="33" y2="4" stroke="#f472b6" strokeWidth="2.5" strokeLinecap="round"/>
              <line x1="9" y1="10" x2="3" y2="4" stroke="#f472b6" strokeWidth="2.5" strokeLinecap="round"/>
            </svg>

            {/* Food bowl — positioned so it overlaps chat card */}
            <img
              src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=520&auto=format&fit=crop&q=80"
              alt="Food bowl"
              className="absolute rounded-full object-cover shadow-2xl z-20"
              style={{ width: "380px", height: "380px", left: "80px", top: "50%", transform: "translateY(-50%)" }}
            />

            {/* Chat card — food overlaps its left edge */}
            <div className="relative bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-10 mr-6" style={{ width: "340px", flexShrink: 0 }}>
              {/* Chat header */}
              ...
              <div className="px-4 pb-3">
                <div className="flex items-center gap-2 bg-gray-50 rounded-full px-3 py-2 border border-gray-200">
                  <button className="text-gray-400"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg></button>
                  <span className="text-sm text-gray-400 flex-1">Message lunch crew...</span>
                  <button className="w-7 h-7 rounded-full flex items-center justify-center text-white" style={{ background: "#5a7a2e" }}>
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L5.999 12Zm0 0h7.5" /></svg>
                  </button>
                </div>
              </div>
            </div>
      ...
      <div id="features" className="max-w-5xl mx-auto px-8 pt-10 pb-8">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            {
              bgIcon: "#eef3e6", iconColor: "#5a7a2e",
              icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" /></svg>,
              title: "GROUP\nORDERING", desc: "Create or join groups by restaurant. Set a member cap and order deadline.",
            },
            {
              bgIcon: "#fdf0e8", iconColor: "#e8834a",
              ...
              title: "REAL-TIME\nCHAT", desc: "Decide together what to order live. No delays, no back-and-forth texting.",
            },
            {
              bgIcon: "#fde8ee", iconColor: "#e8507a",
              ...
              title: "DIETARY\nFILTERS", desc: "Filter groups by dietary restrictions, flex dollars, and time remaining.",
            },
            {
              bgIcon: "#fef3e2", iconColor: "#d4a020",
              icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" /></svg>,
              title: "ONE EASY\nPAYMENT", desc: "Place one order and pay together. No more splitting headaches.",
            },
          ].map((card) => (
            <div key={card.title} className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
              <div className="flex items-start gap-3 mb-3">
                <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: card.bgIcon, color: card.iconColor }}>
                  {card.icon}
                </div>
      ...
      {/* ── HOW IT WORKS — image 4 style: horizontal inline row ── */}
      <div id="how-it-works" className="max-w-5xl mx-auto px-8 pt-8 pb-8">
        <h2 className="text-center font-black uppercase mb-6 tracking-wide" style={{ fontSize: "1.15rem", color: "#1a1a0e", letterSpacing: "0.04em" }}>
          HOW IT WORKS
        </h2>

        {/* Single row: step — dashes — step — dashes — step */}
        <div className="flex items-center justify-between gap-0">
          ...
          <div className="flex items-center gap-3 flex-1">
            <div className="relative flex-shrink-0">
              ...
              <div className="absolute -top-1 -left-1 w-5 h-5 rounded-full text-white text-[10px] font-black flex items-center justify-center" style={{ background: "#5a7a2e" }}>1</div>
            </div>
            <div>
              <h4 className="text-xs font-black uppercase tracking-wide" style={{ color: "#1a1a0e" }}>CREATE OR JOIN A GROUP</h4>
              <p className="text-xs mt-0.5" style={{ color: "#777" }}>Use your .edu email to get started.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 flex-1">
            <div className="relative flex-shrink-0">
              <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{ background: "#fdf0e8" }}>
              ...
              <div className="absolute -top-1 -left-1 w-5 h-5 rounded-full text-white text-[10px] font-black flex items-center justify-center" style={{ background: "#e8834a" }}>2</div>
            </div>
            <div>
              <h4 className="text-xs font-black uppercase tracking-wide" style={{ color: "#1a1a0e" }}>CHAT &amp; DECIDE</h4>
              <p className="text-xs mt-0.5" style={{ color: "#777" }}>Vote, chat, and lock in on a place to eat.</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 flex-1">
            <div className="relative flex-shrink-0">
              <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{ background: "#fde8ee" }}>
                <svg className="w-7 h-7" style={{ color: "#e8507a" }} fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                </svg>
              </div>
              <div className="absolute -top-1 -left-1 w-5 h-5 rounded-full text-white text-[10px] font-black flex items-center justify-center" style={{ background: "#e8507a" }}>3</div>
            </div>
            <div>
              <h4 className="text-xs font-black uppercase tracking-wide" style={{ color: "#1a1a0e" }}>ORDER &amp; ENJOY</h4>
              <p className="text-xs mt-0.5" style={{ color: "#777" }}>Place the order and the leader pays. You enjoy.</p>
            </div>
          </div>
      ...
      <div className="relative overflow-hidden border-t py-14 px-8" style={{ background: "#e8eedd", borderColor: "#d4e4b0" }}>
        ...
        <div className="relative z-10 text-center">
          <p className="font-black uppercase tracking-wide mb-1" style={{ fontSize: "1.5rem", color: "#1a1a0e", letterSpacing: "0.03em" }}>
          ...
          <Link href="/signup" className="inline-flex items-center gap-2 px-8 py-3 text-white rounded-xl font-bold text-sm hover:opacity-90 transition-colors shadow-md" style={{ background: "#5a7a2e" }}>
            Create your account
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
            </svg>
