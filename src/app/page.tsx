  ...
  return (
    <div className="min-h-screen" style={{ background: "#f0ece3" }}>
      ...
      <div className="relative overflow-hidden" style={{ background: "#f0ece3" }}>
        ...
        <div className="absolute top-3 right-3 pointer-events-none opacity-40" style={{ zIndex: 0 }}>
        ...
        {/* Full-width row: text left, bowl+card fill the rest */}
        <div className="flex items-center w-full" style={{ minHeight: "540px", paddingLeft: "48px" }}>

          {/* ── COL 1: Text ── */}
          <div style={{ width: "300px", flexShrink: 0, position: "relative", zIndex: 10 }}>
            ...
            <h1 className="font-black uppercase leading-none mb-4" style={{ fontSize: "3.2rem", color: "#1a1a0e", lineHeight: 1.0 }}>
              ORDER FOOD<br />
              TOGETHER,{" "}
              <span style={{ color: "#6b8f3e" }}>WITHOUT<br />THE CHAOS</span>
            </h1>
          ...
          {/* ── RIGHT SIDE: bowl behind card, fills remaining width ── */}
          <div className="relative flex-1 flex items-center" style={{ minHeight: "540px" }}>

            {/* Spark accent */}
            <svg
              className="absolute pointer-events-none"
              style={{ top: "60px", left: "60px", zIndex: 6 }}
            ...
            {/* Bowl — behind card, no circle */}
            <div style={{ position: "absolute", left: "0px", top: "50%", transform: "translateY(-50%)", zIndex: 5 }}>
              <img
            ...
            {/* Chat card — on top, pushed right so bowl peeks from behind */}
            <div
              className="absolute bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden"
              style={{ left: "300px", top: "50%", transform: "translateY(-50%)", width: "400px", zIndex: 20 }}
            >
              {/* Header */}
